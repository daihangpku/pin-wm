...
from diff_rendering.gaussian_splatting_2d.utils.render_utils import save_img_f32, save_img_u8
...
class GaussianExtractor(object):
    ...
    def estimate_bounding_sphere(self):
        ...
        """
        from diff_rendering.gaussian_splatting_2d.utils.render_utils import transform_poses_pca, focus_point_fn
    ...
    def extract_mesh_bounded(self, voxel_size=0.004, sdf_trunc=0.02, depth_trunc=3, mask_backgrond=True):
        ...
        for i, cam_o3d in tqdm(enumerate(to_cam_open3d(self.viewpoint_stack)), desc="TSDF integration progress"):
            ...
            if mask_backgrond and (self.viewpoint_stack[i].gt_alpha_mask is not None):
                depth[(self.viewpoint_stack[i].gt_alpha_mask < 0.1)] = 0
    ...
    def export_image(self, path):
        ...
        for idx, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="export images"):
            ...
            save_img_u8(self.depthmaps[idx][0].cpu().numpy(), os.path.join(vis_path, 'depth_{0:05d}'.format(idx) + ".png"))
