...
import numpy as np
from diff_rendering.gaussian_splatting_2d.utils.graphics_utils import getWorld2View2, getProjectionMatrix

class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask, mask,
                 image_name, uid,
